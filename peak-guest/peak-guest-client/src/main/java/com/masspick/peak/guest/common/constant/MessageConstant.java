...
public class MessageConstant {
     ...
     * @return String
     */
    public static String getWelcomeMessage(String nickName) {
        return "系统消息:" + nickName + "欢迎登录方舟企业贷款申请平台。";
    }

    /**
     * @return String
     */
    public static String getCreateApplyMessage() {
        return "您已经申请贷款成功，正在处理中，请等待客服人员联系！";
    }

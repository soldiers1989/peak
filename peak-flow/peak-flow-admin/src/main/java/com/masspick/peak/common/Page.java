...
public class Page<T> {
     ...
     * pageNo
     */
    private static int pageNo = 1; // 当前页码
     ...
     * PAGE_PER
     */
    private static final int PAGE_PER = 20;
     ...
     * pageSize
     */
    private int pageSize = PAGE_SIZE; // 页面大小，设置为“-1”表示不进行分页（分页无效）
     ...
     * length
     */
    private int length = LENGTH; // 显示页面长度
     ...
     * @return List
     */
    public List<T> getPagedList(int pageNo, int pageSize, List<T> data) {
    ...
    public Page(HttpServletRequest request, HttpServletResponse response) {
        this(request, response, DEFAULT_PAGE_SIZE);
    }
    ...
    public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize) {
        ...
        } else if (defaultPageSize != DEFAULT_PAGE_SIZE) {
        ...
        // 设置排序参数
        String orderByProperty = request.getParameter(ORDERBY);
        if (StringUtils.isNotBlank(orderByProperty)) {
            this.setOrderBy(orderByProperty);
        }
    }
    ...
    public void initialize() {
        ...
        this.last = (int) (count / (this.pageSize < 1 ? PAGE_PER : this.pageSize) + first - 1);
    ...
    public void setPageSize(int pageSize) {
        this.pageSize = pageSize <= 0 ? PAGE_SIZE_PER : pageSize; // > 500 ? 500 : pageSize;
    }

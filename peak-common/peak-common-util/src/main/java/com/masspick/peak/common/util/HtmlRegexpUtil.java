...
/**
 * Created by admin on 2018/4/17 0017.
 */
public class HtmlRegexpUtil {
     ...
     * 找出IMG标签
     */
    private static final String REGXP_FOR_IMG_TAG = "<\\s*img\\s+([^>]*)\\s*>";

    /**
     * 找出IMG标签的SRC属性
     */
    private static final String REGXP_FOR_IMA_TAG_SRC_ATTRIB = "src=\"([^\"]+)\"";
    ...
    public static String filterChinese(String chin) {
        chin = chin.replaceAll(REG_CHINESE, "");
        return chin;
    }
